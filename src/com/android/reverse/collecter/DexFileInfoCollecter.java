...
public class DexFileInfoCollecter {
    ...
    public void start() throws Throwable {
        ...
        hookhelper.hookMethod(defineClassNativeMethod, new XC_MethodHook() {
            @Override
    ...
    public String[] dumpLoadableClass(String dexPath) {
        ...
        if (mCookie != 0) {
            return (String[])RefInvoke.invokeStaticMethod("dalvik.system.DexFile", "getClassNameList", new Class[]{long.class},
                    new Object[]{mCookie});
        } else {
